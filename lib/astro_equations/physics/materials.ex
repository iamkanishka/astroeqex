defmodule AstroEquations.Physics.Materials do
  ...
  def density(mass, volume) when volume != 0, do: mass / volume * 1.0
  ...
  def number_density(count, volume), do: count / volume * 1.0
  ...
  def normal_stress(force, area), do: force / area * 1.0
  ...
  def normal_strain(delta_l, l0), do: delta_l / l0 * 1.0
  ...
  def youngs_modulus(stress, strain), do: stress / strain * 1.0
  ...
  def shear_stress(shear_force, area), do: shear_force / area * 1.0
  ...
  def shear_modulus(shear_stress, shear_strain), do: shear_stress / shear_strain * 1.0
  ...
  ## Examples
      ...
      0.0012
  """
  @spec linear_expansion(number, number, number) :: float
  ...
  ## Examples
      ...
      0.0036
  """
  @spec volumetric_expansion(number, number, number) :: float
  ...
  def thermal_diffusivity(k, density, specific_cp) do
  ...
  ## Examples
      ...
      0.1
  """
  @spec viscous_shear_stress(number, number) :: float
  def viscous_shear_stress(eta, dv_dy), do: eta * dv_dy * 1.0
  ...
  def kinematic_viscosity(eta, rho), do: eta / rho * 1.0
  ...
  def reynolds_number(rho, v, l, eta), do: rho * v * l / eta * 1.0
  ...
  def particle_relaxation_time(particle_density, diameter, viscosity) do
    particle_density * diameter ** 2 / (18 * viscosity)
  end
  ...
  def speed_of_sound_solid(youngs_modulus, density) do
  ...
  def speed_of_sound_liquid(bulk_modulus, density) do
  ...
  def speed_of_sound_gas(gamma, temperature, molar_mass, r \\ 8.31446) do
  ...
  def polytropic_pressure(k, rho, gamma), do: k * :math.pow(rho, gamma)
end
