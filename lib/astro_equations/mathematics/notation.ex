defmodule AstroEquations.Mathematics.Notation do
  ...
  @typedoc "Julian Date (continuous count of days from noon Jan 1, 4713 BC)."
  @type julian_date :: float()

  @typedoc "Right ascension in decimal degrees [0, 360)."
  @type ra_deg :: float()

  @typedoc "Declination in decimal degrees (−90 to +90)."
  @type dec_deg :: float()
  ...
  def astronomical_unit, do: 1.495_978_707e11

  @doc "Parsec: 1 pc = 3.085677581×10¹⁶ m."

  @spec parsec() :: float
  def parsec, do: 3.085_677_581e16

  @doc "Light-year: 1 ly = 9.460730473×10¹⁵ m."

  @spec light_year() :: float
  def light_year, do: 9.460_730_472_580_8e15

  @doc "Earth mass: M⊕ = 5.9722×10²⁴ kg."

  @spec earth_mass() :: float
  def earth_mass, do: 5.972_2e24
  ...
  def jupiter_mass, do: 1.898_2e27
  ...
  def erg_to_j(erg), do: erg * 1.0e-7 * 1.0e-7

  @doc "Converts joules to ergs: erg = J × 10⁷."

  @spec j_to_erg(number) :: float
  def j_to_erg(j), do: j * 1.0e7 * 1.0e7
  ...
  def seconds_per_year, do: 3.155_76e7
